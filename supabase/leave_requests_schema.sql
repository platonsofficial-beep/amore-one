...
create table if not exists public.leave_requests (
  ...
  created_by uuid null references public.workspace_members(id) on delete restrict,
  decided_by uuid null references public.workspace_members(id) on delete restrict,
